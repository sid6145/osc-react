...
const DashboardHeader = (props) => {
  ...
  const { cart, cartCount } = useSelector((state) => state.dashboardSlice);
  const dispatch = useDispatch()
  const increasedValue =
  totalCartPrice + totalCartPrice * (7 / 100);
      ...
      >
        <div className="drawer-content">
          ...
          <div className="drawer-footer">
            <CartPrice totalCartPrice={totalCartPrice} increasedValue={increasedValue}/>
            <div className="place-order-root">
              <p>Your Saving on this order ₹{parseInt(increasedValue - totalCartPrice)}</p>
